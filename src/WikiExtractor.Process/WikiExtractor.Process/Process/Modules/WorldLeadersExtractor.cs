...
namespace WikiExtractor.Process.Modules
{
    public class WorldLeadersExtractor : DataExtractorBase
    {
        ...
        public void ExtractData()
        {
            ...
            var stkIreland = toStore.ExtractListTabularData("Ireland", "/wiki/List_of_taoisigh_of_Ireland", new List<string> { "All", "IRL PM" }).ToStack();
            ...
            var stkUzbekistan = toStore.ExtractListTabularData("Uzbekistan", "/wiki/List_of_presidents_of_Uzbekistan", new List<string> { "All", "UZB Pre" }).ToStack();
            ...
            var stkMorocco = toStore.ExtractListTabularData("Morocco", "/wiki/List_of_kings_of_Morocco", new List<string> { "All", "MAR Kng" }).ToStack();
            ...
            var stkSouthAfrica = toStore.ExtractListTabularData("SouthAfrica", "/wiki/List_of_presidents_of_South_Africa", new List<string> { "All", "ZAF Pre" }).ToStack();
            ...
            var stkKenya = toStore.ExtractListTabularData("Kenya", "/wiki/List_of_presidents_of_Kenya", new List<string> { "All", "KEN Pre" }).ToStack();
            ...
            var stkGhana = toStore.ExtractListTabularData("Ghana", "/wiki/List_of_presidents_of_Ghana", new List<string> { "All", "GHA Pre" }).ToStack();
