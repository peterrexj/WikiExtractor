...
namespace WikiExtractor.Process.Extractor
{
    ...
    {
        public List<WikiWhatToExtractModel> ExtractListTabularData_Panama(HtmlDocument document, List<string>? tags)
        {
            ...
            foreach (var table in tableData)
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    {
                        var r = ExtractListTabularData_Panama_Rows(cells);
        ...
        private WikiWhatToExtractModel? ExtractListTabularData_Panama_Rows(HtmlNode[] elements)
        {
