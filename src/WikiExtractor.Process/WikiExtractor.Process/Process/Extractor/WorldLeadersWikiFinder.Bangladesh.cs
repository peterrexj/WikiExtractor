...
namespace WikiExtractor.Process.Extractor
{
    ...
    {
        public List<WikiWhatToExtractModel> ExtractListTabularData_Bangladesh(HtmlDocument document, List<string>? tags)
        {
            ...
            foreach (var table in tableData)
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    {
                        var r = ExtractListTabularData_Bangladesh_Rows(cells);
        ...
        private WikiWhatToExtractModel? ExtractListTabularData_Bangladesh_Rows(HtmlNode[] elements)
        {
            var m = new WikiWhatToExtractModel();
            m.AdditionalMetaData!.Add("Country", "Bangladesh");
            int c = 1;
            foreach (var elm in elements)
            {
                // td1=ordinal, td2=portrait, td3=name, td4=election, td5=took, td6=left, td7=tenure, td8=party
