...
namespace WikiExtractor.Process.Extractor
{
    ...
    {
        public List<WikiWhatToExtractModel> ExtractListTabularData_Malaysia(HtmlDocument document, List<string>? tags)
        {
            ...
            foreach (var table in tableData.Take(1))
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    {
                        var r = ExtractListTabularData_Malaysia_Rows(cells);
        ...
        private WikiWhatToExtractModel? ExtractListTabularData_Malaysia_Rows(HtmlNode[] elements)
        {
            var m = new WikiWhatToExtractModel();
            m.AdditionalMetaData!.Add("Country", "Malaysia");
            int c = 1;
            foreach (var elm in elements)
            {
                // td1=ordinal, td2=portrait, td3=name, td4=took, td5=left, td6=tenure, td7=election, td8=empty, td9=party
