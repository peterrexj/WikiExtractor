...
namespace WikiExtractor.Process.Extractor
{
    ...
    {
        public List<WikiWhatToExtractModel> ExtractListTabularData_Mexico(HtmlDocument document, List<string>? tags)
        {
            ...
            foreach (var table in tableData)
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    {
                        var r = ExtractListTabularData_Mexico_Rows(cells);
        ...
        private WikiWhatToExtractModel? ExtractListTabularData_Mexico_Rows(HtmlNode[] elements)
        {
            var m = new WikiWhatToExtractModel();
            m.AdditionalMetaData!.Add("Country", "Mexico");
            int c = 1;
            // 7-TD rows: c1=portrait, c2=name, c3=took, c4=left, c5=tenure
            // 8-TD rows (with Elected at c3): c1=portrait, c2=name, c3=elected, c4=took, c5=left, c6=tenure
