...
namespace WikiExtractor.XamarinForms.ViewModels
{
    public class QuizPageQuestionViewModel : BaseViewModel
    {
        ...
        public string MasterPicLocalFileName => $"{MasterName.RemoveSpecialChars(excludeUnderscore: false)}{Path.GetExtension(MasterPicPath)}";
        ...
        public bool HasUserAnswered => UserSelection.HasValue();
        ...
        public IStyleModel DefaultStyle
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(QuizUserAnswerBasedBackgroundColor));
            }
        }

        public string QuizUserAnswerBasedBackgroundColor =>
            HasUserAnswered
                ? IsCorrect ? DefaultStyle.ChartCorrectAnswerColor : DefaultStyle.ChartWrongAnswerColor
                : DefaultStyle.ChartNotAnsweredColor;
