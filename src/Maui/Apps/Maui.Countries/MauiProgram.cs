...
#if ANDROID
            appInfo = new Maui.Countries.Platforms.Android.DependencyInjection.AppInformation();
...
#elif IOS
            appInfo = new Maui.Countries.Platforms.iOS.DependencyInjection.AppInformation();
            builder.Services.AddSingleton<IAppInformation>(appInfo);
