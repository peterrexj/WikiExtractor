...
# Usage:
#   ./run-ios-countries.sh                # iPhone 17 Pro (default)
#   ./run-ios-countries.sh --ipad         # iPad Pro 13-inch (M5)
#   ./run-ios-countries.sh --device "iPad mini (A17 Pro)"
#   ./run-ios-countries.sh --clean                        # clean before build

PROJECT="Maui.Countries.csproj"
APP_BUNDLE="bin/Debug/net10.0-ios26.5/iossimulator-arm64/Maui.Countries.app"
