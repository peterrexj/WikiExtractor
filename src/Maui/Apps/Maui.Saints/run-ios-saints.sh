...
# Usage:
#   ./run-ios-saints.sh                   # iPhone 17 Pro (default)
#   ./run-ios-saints.sh --ipad            # iPad Pro 13-inch (M5)
#   ./run-ios-saints.sh --device "iPad mini (A17 Pro)"
#   ./run-ios-saints.sh --clean                        # clean before build

PROJECT="Maui.Saints.csproj"
APP_BUNDLE="bin/Debug/net10.0-ios26.5/iossimulator-arm64/Maui.Saints.app"
