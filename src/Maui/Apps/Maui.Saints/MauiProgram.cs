...
#if ANDROID
            appInfo = new Maui.Saints.Platforms.Android.DependencyInjection.AppInformation();
...
#elif IOS
            appInfo = new Maui.Saints.Platforms.iOS.DependencyInjection.AppInformation();
            builder.Services.AddSingleton<IAppInformation>(appInfo);
