...
namespace WikiExtractor.Process.Modules
{
    public class WorldLeadersExtractor : DataExtractorBase
    {
        ...
        public void ExtractData()
        {
            ...
            wikiAppController!.AddMenuItem("World Leaders", "Recent", "World Leaders", menuItemCounter++);
            wikiAppController.AddMenuItem("Australia Prime Minister", "Australia PM", "Australia", menuItemCounter++);
            ...
            //
            var listUnitedKingdom = toStore.ExtractListTabularData_UnitedKingdom("/wiki/List_of_prime_ministers_of_the_United_Kingdom", new List<string> { "All", "Pope Benedict XVI" });
            var listUnitedStates = toStore.ExtractListTabularData_UnitedStates("/wiki/List_of_presidents_of_the_United_States", new List<string> { "All", "Pope Benedict XVI" });
            var listIndia = toStore.ExtractListTabularData_India("/wiki/List_of_prime_ministers_of_India", new List<string> { "All", "Pope Benedict XVI" });
            var listAustralia = toStore.ExtractListTabularData_Australia("/wiki/List_of_prime_ministers_of_Australia", new List<string> { "All", "Pope Benedict XVI" });
            ...
            var worldleadersCollection = listAustralia
                .Union(listIndia)
                .ToList();
